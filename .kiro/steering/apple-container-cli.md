...
ctui requires container CLI v1.0.0 or later. The 1.0 release removed
compatibility with v0 XPC APIs, so clients and servers must both be v1.

On startup, ctui checks the CLI version and exits with a clear upgrade
